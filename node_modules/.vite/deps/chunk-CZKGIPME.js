...
var __spreadArray = function(to2, from6, pack) {
  if (pack || arguments.length === 2) for (var i3 = 0, l6 = from6.length, ar2; i3 < l6; i3++) {
    if (ar2 || !(i3 in from6)) {
      if (!ar2) ar2 = Array.prototype.slice.call(from6, 0, i3);
      ar2[i3] = from6[i3];
    }
  }
  return to2.concat(ar2 || Array.prototype.slice.call(from6));
};
var BrowserInfo = (
  /** @class */
  /* @__PURE__ */ function() {
...
function base(ALPHABET2) {
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i3 = 0;
      for (let it3 = size3 - 1; (carry !== 0 || i3 < length2) && it3 !== -1; it3--, i3++) {
...
function base2(ALPHABET2, name2) {
  ...
  function decodeUnsafe(source) {
    ...
    while (source[psz]) {
      ...
      var i4 = 0;
      for (var it3 = size3 - 1; (carry !== 0 || i4 < length2) && it3 !== -1; it3--, i4++) {
        carry += BASE * b256[it3] >>> 0;
        b256[it3] = carry % 256 >>> 0;
        carry = carry / 256 >>> 0;
      }
...
var from = ({ name: name2, prefix, encode: encode7, decode: decode7 }) => new Codec(name2, prefix, encode7, decode7);
var baseX = ({ prefix, name: name2, alphabet: alphabet2 }) => {
  const { encode: encode7, decode: decode7 } = base_x_default(alphabet2, name2);
  return from({
    prefix,
    name: name2,
    encode: encode7,
...
function createCodec(name2, prefix, encode7, decode7) {
  return {
    name: name2,
    prefix,
    encoder: {
...
*/
//# sourceMappingURL=chunk-CZKGIPME.js.map
